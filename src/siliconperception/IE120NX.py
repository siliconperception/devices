...
class IE120NX(
    ...
    def __init__(self):
        ...
        self.layer10 = nn.Sequential(nn.Conv2d(64, 384, kernel_size=3, stride=2), nn.BatchNorm2d(384), nn.ReLU())
        self.layer11 = nn.Sequential(nn.Conv2d(384, 384, kernel_size=3, stride=1), nn.BatchNorm2d(384), nn.ReLU())
        self.layer12 = nn.Sequential(nn.Conv2d(384, 384, kernel_size=3, stride=1), nn.BatchNorm2d(384), nn.ReLU())
        self.layer13 = nn.Sequential(nn.Conv2d(384, 512, kernel_size=3, stride=2), nn.BatchNorm2d(512), nn.ReLU())
        ...
        self.layer16 = nn.Sequential(nn.Conv2d(512, 768, kernel_size=3, stride=2), nn.BatchNorm2d(768), nn.ReLU())
        self.layer17 = nn.Sequential(nn.Conv2d(768, 768, kernel_size=1, stride=1), nn.BatchNorm2d(768), nn.ReLU())
        self.layer18 = nn.Sequential(nn.Conv2d(768, 768, kernel_size=1, stride=1))
