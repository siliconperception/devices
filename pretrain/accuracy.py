...
parser.add_argument('--log_medium',help='log file name',default='log/log.2024.11.12-07.09.18')
...
ax1.plot(arr_m[n_col],arr_m[loss_col],'-m', linewidth=1,alpha=0.5,label='IE120R-medium (18.65M weights, 8.04G MAC)')
